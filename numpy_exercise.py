...
print("-----------------------------------------------   STEP ONE   -----------------------------------------------")
reigister_total = sum(salesArray)
print(sum(reigister_total))
print()
...
print("-----------------------------------------------   STEP THREE  -----------------------------------------------")
print(np.greater_equal(salesArray, 100))
print()

## Step 4: Print the total sales for each register.
print("-----------------------------------------------   STEP FOUR   -----------------------------------------------")
print(sum(salesArray))
print()
...
print("-----------------------------------------------   STEP FIVE  -----------------------------------------------")
salesTax = np.multiply(salesArray.copy(), .02)
print(salesTax)
print()
...
print("-----------------------------------------------   STEP SIX  -----------------------------------------------")
salesProfit = np.multiply(salesArray.copy(), .98)
print()
